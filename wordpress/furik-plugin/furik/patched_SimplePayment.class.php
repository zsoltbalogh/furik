...
class SimpleLiveUpdate extends SimpleTransaction
{
    ...
    protected $validFields = array(
        ...
        //billing
        "BILL_FNAME" => array("type" => "single", "required" => false),
        "BILL_LNAME" => array("type" => "single", "required" => false),
        "BILL_COMPANY" => array("type" => "single"),
        "BILL_FISCALCODE" => array("type" => "single"),
        "BILL_EMAIL" => array("type" => "single", "required" => true),
        "BILL_PHONE" => array("type" => "single", "required" => false),
        "BILL_FAX" => array("type" => "single"),
        "BILL_ADDRESS" => array("type" => "single", "required" => false),
        "BILL_ADDRESS2" => array("type" => "single"),
        "BILL_ZIPCODE" => array("type" => "single", "required" => false),
        "BILL_CITY" => array("type" => "single", "required" => false),
        "BILL_STATE" => array("type" => "single", "required" => false),
        "BILL_COUNTRYCODE" => array("type" => "single", "required" => false),
        
        //delivery
        "DELIVERY_FNAME" => array("type" => "single", "required" => false),
        "DELIVERY_LNAME" => array("type" => "single", "required" => false),
        "DELIVERY_COMPANY" => array("type" => "single"),
        "DELIVERY_EMAIL" => array("type" => "single"),
        "DELIVERY_PHONE" => array("type" => "single", "required" => false),
        "DELIVERY_ADDRESS" => array("type" => "single", "required" => false),
        "DELIVERY_ADDRESS2" => array("type" => "single"),
        "DELIVERY_ZIPCODE" => array("type" => "single", "required" => false),
        "DELIVERY_CITY" => array("type" => "single", "required" => false),
        "DELIVERY_STATE" => array("type" => "single", "required" => false),
        "DELIVERY_COUNTRYCODE" => array("type" => "single", "required" => false),
    );
